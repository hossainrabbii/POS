...
export const verifyEmailController = async (req: Request, res: Response) => {
  const data = verifyEmailValidation.parse(req.body);

  const result = await verifyEmail(data.email, data.otp);
...
export const refreshToken = async (req: Request, res: Response) => {
  const data = refreshTokenValidation.parse(req.body);
...
export const forgotPasswordController = async (req: Request, res: Response) => {
  const data = forgotPasswordValidation.parse(req.body);
...
export const verifyResetOtpController = async (req: Request, res: Response) => {
  const data = verifyResetOtpValidation.parse(req.body);
...
export const resetPasswordController = async (req: Request, res: Response) => {
  ...
  await resetPassword(data.resetToken, data.password);
  res.status(200).json({
    success: true,
